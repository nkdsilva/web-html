        ...
        stage('Deploy') {
            steps {
                sshagent(['apache-ssh-key']) {
                  ...
                  sh 'scp index.html ubuntu@15.134.33.63 /home/ubuntu/'
                  sh 'sudo chown -R ubuntu:ubuntu /var/www/html'
                  sh 'ssh ubuntu@$APP_SERVER_IP "sudo mv /home/ubuntu/index.html /var/www/html/"'
